...
[**@konimex**](https://github.com/konimex), [**@iandrewt**](https://github.com/iandrewt), [**@arisinfenix**](https://github.com/arisinfenix), [**@xPMo**](https://github.com/xPMo), [**@nero**](https://github.com/nero), [**@alyssais**](https://github.com/alyssais), [**@plgruener**](https://github.com/plgruener), [**@StarryTony**](https://github.com/StarryTony), [**@julianaito**](https://github.com/julianaito), [**@HolyStephano**](https://github.com/HolyStephano), [**@nikitenich**](https://github.com/nikitenich), [**@Appadeia**](https://github.com/Appadeia), [**@marlonn**](https://github.com/marlonn), [**@Snuggle**](https://github.com/dylanaraps/neoneofetch/commits?author=Snuggle), [**@Phuurl**](https://github.com/Phuurl), [**@erikdubois**](https://github.com/erikdubois)
...
neoneofetch --ascii "$(fortune|cowsay -W 30)"

# use figlet as ascii art.
neoneofetch --ascii "$(figlet -w 30 hello world)"
```

<img src="https://i.imgur.com/ozoXAvz.jpg" alt="scrot" height="400px">

- Added a new "simple" mode. You can now use neoneofetch for scripting by getting it to output individual info functions in plain text.

```sh
# Example:
neoneofetch uptime --uptime_shorthand tiny
> uptime: 32m

# Example:
neoneofetch uptime disk wm memory
> uptime: 33 mins
> disk (/): 212G / 235G (96%)
> wm: Openbox
...
memory="$(neoneofetch memory)"; memory="${memory##*: }"

# For multiple outputs at once (each line of info in an array):
# Much faster than running neoneofetch multiple times.
IFS=$'\n' read -d "" -ra info < <(neoneofetch memory uptime wm)
info=("${info[@]##*: }")
```
...
- **Kitty**: Update docs. [**@Snuggle**](https://github.com/dylanaraps/neoneofetch/commits?author=Snuggle)
...
- **cursor**: Fixed prompt location issues after Neoneofetch is run.
- **macOS**: Fixed neoneofetch launching XQuartz.
...
See: https://github.com/dylanaraps/neoneofetch/issues/1001
...
Neoneofetch now has a Discord server. Come and join the discussion!
...
- Neoneofetch now assumes target directories (config file and ASCII directory) at install time, this fixes problems with systems such as NixOS.
...
- Added support for using all image types as input.
    - Neoneofetch now supports `svg`, `tiff` etc.
...
- [AIX/IRIX] Fixed Neoneofetch crashing when calculating uptime.
...
- Minimum required BASH version is now 3.2.
    - (Neoneofetch has always used 3.2+ features, I've just made it obvious now in the documentation.)
- Fixed config file not being created on first install.


## Images

- [w3m] Added `--loop` flag which makes Neoneofetch draw the image once per second.
...
Though I haven't worked on Neoneofetch as much as I'd have liked, most of the changes this time round come from some familiar faces as well as some new contributors! Thanks to everyone for contributing, I appreciate it.
...
The screenshot feature no longer requires any configuration before working. We no longer hardcode `${HOME}/Pictures/neoneofetch` as the screenshot location. Here's how the `-s` and `-su` flags now function:

- `neoneofetch -s` will save a file in the current directory named: `neoneofetch-$(date +%F-%I-%M-%S-${RANDOM}).png`
- `neoneofetch -s test.png` will save a file in the current directory called `test.png`
- `neoneofetch -s ~/` will save a file in `~` called `neoneofetch-$(date +%F-%I-%M-%S-${RANDOM}).png`
- `neoneofetch -s ~/test.png` will save a file in `~` called `test.png`.
...
Neoneofetch now supports displaying images using `catimg`, `libcaca` and `jp2a`. See this wiki page for screenshots. https://github.com/dylanaraps/neoneofetch/wiki/Image-Backends
...
## General
- The default config file is now installed to `/etc/neoneofetch/config` and acts as a system-wide config file for Neoneofetch. Editing this file will make the changes available to all users on the system. Those packaging Neoneofetch **without** using the Makefile will need to make changes to support this.
...
- All of the image/ascii backend handling was rewritten. Backend and Image/File/Directory selection is universal now and should make usage easier.
  ...
  - Shortcut flags were added for easy picking of backends.
    ...
    - For example: `neoneofetch --w3m /path/to/img.jpg` `neoneofetch --ascii /path/to/file`
    - `--w3m`
    - `--iterm2`
    - `--tycat`
    - `--ascii`
...
I also want to apologize to those packaging Neoneofetch for this unexpected release.
...
This release of Neoneofetch fixes some important bugs that were found after 2.0 was release. This includes: Detection issues on CentOS and Linux Mint systems, Incorrect Memory usage on BSD, Linux GPU detection issues and more.

This release also includes a rewrite of the screenshot functions. You no longer have to set the program to use in your config. Neoneofetch now automatically finds and uses whatever screenshot tool is available on your machine.

See the screenshot section below for more info.

The `get_packages()` function was optimized. Neoneofetch's packages function works by detecting which package managers are installed on your system and then using a sum of those as the packages output.
...
Thanks for reporting these bugs and also suggesting these features. Don't be shy, report any bugs, annoyances or etc with Neoneofetch and I'll happily help you out.
...
- Changed default image mode to `ascii`.
  - See: [Images in the terminal](https://github.com/dylanaraps/neoneofetch/wiki/Images-in-the-terminal#enabling-image-mode)
...
- Updated Ubuntu logo to the latest version.
  - You can use the old logo by launching neoneofetch with `--ascii_distro ubuntu_old` or by changing `$ascii_distro` to `ubuntu_old` in your config file.
- `--ascii_colors` no longer changes text colors.
- Added ascii art for Ubuntu-Budgie.
  - You can use the ascii art by launching Neoneofetch with `--ascii_distro ubuntu-budgie` or by changing `$ascii_distro` to `ubuntu-budgie` in your config file.
- Fixed bug causing RFRemix to use the incorrect ascii art.

## Screenshots

Neoneofetch will now automatically find and use whatever screenshot tool is available on your system. The screenshot tool is no longer hardcoded and you don't have to edit your config file to specify what program to use.

On Haiku and macOS, Neoneofetch will use the built-in tools to take screenshots. On systems with an X server Neoneofetch will look for and use the following programs: `scrot`, `maim`, `import (imagemagick)`, `imlib2_grab` and `gnome-screenshot`.
...
This is the biggest release of Neoneofetch in a long time. 97 files were changed with 2700~ additions to 2900~ deletions. Although the changelog isn't as interesting this time majority of the script has been rewritten, restructered and cleaned up. Every function and variable name follows a proper naming scheme and a large number of bugs were fixed.

Since this version of Neoneofetch differs so much from the previous versions expect a 2.0.1 release a few days later to fix any bugs that are found after release.

The ascii file handling was rewritten, ascii art is now stored/read as plain text! All `eval` usage was removed from Neoneofetch, vim fold markers/comments are no longer enforced and we now run on GNU Hurd, Haiku and more.

When I was rewriting parts of the script I thought to myself; Neoneofetch is using the bash shebang and does depend on bash so why not take full advantage of the features bash has to offer? All tests were changed from `[` to `[[`, arithmetic tests now use `(())` and C style for loops are used where possible.

All of the config file documentation was rewritten and multiple wiki pages were created to hopefully make using/configuring Neoneofetch easier than ever before. You can see the wiki here: [Neoneofetch Wiki](https://github.com/dylanaraps/neoneofetch/wiki)

Some of the config options/arguments were renamed/changed and Neoneofetch will warn you on run if you're using deprecated options (`neoneofetch -v`). For this release Neoneofetch **will** include backwards compatibility with the old config file but I'd like to remove this stuff in ~~2.1~~ 3.0. I recommend using this release with a fresh config file so that you can make use of the new documentation.

I say this every release; This changelog is incomplete, for a full list of changes take a look through the commit history. Neoneofetch now has an unspoken commit style so reading the commit history won't hurt as much as it used to.

Thanks to all of the contributors this time around, you guys are a big help and I really appreciate your work towards making Neoneofetch better and better each release. :)
...
## Packages
- Neoneofetch is now in Debian's official repos.
- Neoneofetch is now in Ubuntu's official repos.
...
- Removed all vim fold markers and stopped enforcing folding for vim users.
  - See [#431](https://github.com/dylanaraps/neoneofetch/pull/431)
...
- Neoneofetch now displays your OS's ascii logo if your distro's logo isn't found. **[@konimex](https://github.com/konimex)**
...
Note: Those packaging neoneofetch can ignore the new file: `config/travis`
...
## Packages
- Neoneofetch is now in Termux`s repos.
...
- Removed `--test` in favor of a separate config file. Travis.ci now uses `neoneofetch --config travis` instead of a hacked together arg.
...
I'm also looking for neoneofetch screenshots for the Readme, see this issue: [#405](https://github.com/dylanaraps/neoneofetch/issues/405)
...
- Added support for Android.
  - Dependencies:
    ...
    - Note2: Neoneofetch will be packaged in `termux` thanks to **[@konimex](https://github.com/konimex)**
...
## Packages
- Neoneofetch is now in Gentoo's official repos.
...
I spent yesterday trying to fix this issue and found out that launching neoneofetch with `--bold off`
...
I opened up this PR https://github.com/dylanaraps/neoneofetch/pull/358 which added options to enable a border between the image and the text to fix the issue. **[@konimex](https://github.com/konimex)** later commented informing me that we could just use a `zero-width space` to fix the issue and that we didn't need a new function/args/ugly border. doh

The final fix was as simple as adding a zero-width space before the info, here's the commit.

https://github.com/dylanaraps/neoneofetch/commit/3e9c3d648cb4c6f0d5fe5f0b96f9e29429af39d9

**Removed hard dependency on `\033[14t`**

Neoneofetch no longer requires a terminal emulator that supports `\033[14t` this means that neoneofetch now works in Konsole. Instead of using the escape sequence users now have three options for getting the terminal size in pixels.
- `xdotool`
- `xwininfo` + `xprop`
- `xwininfo` + `xdpyinfo`

Neoneofetch will detect whatever combination you have insalled and use these programs.
...
- [w3m-img] Add `-bg` support with the new option `--bg_color`.
  - `neoneofetch --bg_color blue` will make the background behind the image blue.
...
- [Windows] Added support for custom WMs/Shells.
  - Neoneofetch now detects `blackbox`, `bugn`, `Windawesome`, `emerge` and `litestep`.
...
- [Linux] Rewrite GPU function.
  - Neoneofetch also caches the info until reboot.
...
- Fixed `% s` appearing in color blocks when neoneofetch is run from `tty`
...
**General**<br \>
- Added a tiny delay before running w3m-img which suprisingly fixed all flickering issues in VTE based terminals. See [#349](https://github.com/dylanaraps/neoneofetch/pull/349)
...
This version of neoneofetch is vastly different from the previous versions and this
...
out the open PR here: [#322](https://github.com/dylanaraps/neoneofetch/pull/322)
...
### General
- Added `--version` to print the neoneofetch version.
...
- Moved all whitespace trimming to a dedicated function.
  - Neoneofetch will no longer have any whitespace issues in the output.
  - See [trim()](https://github.com/dylanaraps/neoneofetch/commit/d3c87cdaacf1ea9fbf245146c910dc53b49dba08#diff-e863270127ca6116fd30e708cdc582fcR2789)
...
- The prompt is now dynamically set in image mode instead of being anchored to the<br \>
  bottom of the window. See [#279](https://github.com/dylanaraps/neoneofetch/pull/279) and [#299](https://github.com/dylanaraps/neoneofetch/pull/299) for examples.
...
- Cleanup
- Neoneofetch no longer clears the screen when run in ascii or image=off modes.
  - You can use the old behavior by aliasing `clear && neoneofetch` to `neoneofetch`.
...
- Added Cydia package for iOS.
  - See https://github.com/dylanaraps/neoneofetch#ios-1
...
[2] See this wiki page for more info about the functions: [Link](https://github.com/dylanaraps/neoneofetch/wiki/Terminal-and-Terminal-Font-detection)
...
- Fixed issues with lines getting drawn through images. See [#296](https://github.com/dylanaraps/neoneofetch/pull/296)
...
- Custom ascii files (`--ascii path/to/ascii_file`) now follow the same format as the<br\>
  distro ascii files. See this wiki page that explains the syntax. [Link](https://github.com/dylanaraps/neoneofetch/wiki/Custom-Ascii-art-file-format)
...
haven't had as much time to work on neoneofetch.

As always, check the `Following HEAD` wiki page for all breaking changes
this release.

I'm also looking for some new Readme screenshots, see this github issue: **https://github.com/dylanaraps/neoneofetch/issues/245**
...
- Added support for Apple iOS. **[@iandrewt](https://github.com/iandrewt)**
  - Neoneofetch should now work on your iPhone, iPod and iPad.
...
Neoneofetch now supports displaying error messages and saving a verbose log for
troubleshooting.
...
[1] Use `neoneofetch -vv 2> file` to save a verbose log for bug reporting.
...
[1] Neoneofetch tried to be smart before by assuming that the foreground color
...
Another ~~week~~ another release of Neoneofetch.

This release focused on cleanup, bug fixes and optimization. Neoneofetch
...
https://github.com/dylanaraps/neoneofetch/wiki/Following-HEAD
...
<p align="center">Neoneofetch 1.5  vs  Neoneofetch 1.6</p>

<p align="center">Neoneofetch now works with bright color schemes and uses the foreground color instead of hard-coding white.</p>
...
### Packages
- Neoneofetch is now is Void Linux's official repos. **[@konimex](https://github.com/konimex)**
...
Thanks to the following people for helping me to improve neoneofetch.
- **[@iandrewt](https://github.com/iandrewt)**
- **[@konimex](https://github.com/konimex)**
...
### Packages
- Neoneofetch is now packaged for `Fedora` and `Fedora` based distros. **[@konimex](https://github.com/konimex)**.
- Added installation instructions for RHEL and CentOS. **[@konimex](https://github.com/konimex)**.
- Added stable package to the AUR. **[neoneofetch](https://aur.archlinux.org/packages/neoneofetch/)**
...
the major changes made to neoneofetch. For a full list, checkout the git commit history.

Thanks to everyone for contributing, I appreciate it!
- Renamed `fetch` to `neoneofetch`. Thanks for voting.
- Neoneofetch now has a man page. (man neoneofetch) Thanks **[@konimex](https://github.com/konimex)**
...
``` sh
neoneofetch --birthday_format "%D"
neoneofetch --birthday_format "%a %d %b %Y %l:%M %p"
neoneofetch --birthday_format "%c"
```
...
neoneofetch --stdout memory battery disk --stdout_separator "  |  "
```
...
[Unreleased]: https://github.com/dylanaraps/neoneofetch/compare/5.0.0...HEAD
[5.0.0]: https://github.com/dylanaraps/neoneofetch/compare/4.0.2...5.0.0
[4.0.2]: https://github.com/dylanaraps/neoneofetch/compare/4.0.1...4.0.2
[4.0.1]: https://github.com/dylanaraps/neoneofetch/compare/4.0.0...4.0.1
[4.0.0]: https://github.com/dylanaraps/neoneofetch/compare/3.4.0...4.0.0
[3.4.0]: https://github.com/dylanaraps/neoneofetch/compare/3.3.0...3.4.0
[3.3.0]: https://github.com/dylanaraps/neoneofetch/compare/3.2.0...3.3.0
[3.2.0]: https://github.com/dylanaraps/neoneofetch/compare/3.1.0...3.2.0
[3.1.0]: https://github.com/dylanaraps/neoneofetch/compare/3.0.1...3.1.0
[3.0.1]: https://github.com/dylanaraps/neoneofetch/compare/3.0...3.0.1
[3.0]: https://github.com/dylanaraps/neoneofetch/compare/2.0.2...3.0
[2.0.2]: https://github.com/dylanaraps/neoneofetch/compare/2.0.1...2.0.2
[2.0.1]: https://github.com/dylanaraps/neoneofetch/compare/2.0...2.0.1
[2.0]: https://github.com/dylanaraps/neoneofetch/compare/1.9.1...2.0
[1.9.1]: https://github.com/dylanaraps/neoneofetch/compare/1.9...1.9.1
[1.9]: https://github.com/dylanaraps/neoneofetch/compare/1.8.1...1.9
[1.8.1]: https://github.com/dylanaraps/neoneofetch/compare/1.8...1.8.1
[1.8]: https://github.com/dylanaraps/neoneofetch/compare/1.7...1.8
[1.7]: https://github.com/dylanaraps/neoneofetch/compare/1.6...1.7
[1.6]: https://github.com/dylanaraps/neoneofetch/compare/1.5...1.6
[1.5]: https://github.com/dylanaraps/neoneofetch/compare/1.4...1.5
[1.4]: https://github.com/dylanaraps/neoneofetch/compare/1.3...1.4
[1.3]: https://github.com/dylanaraps/neoneofetch/compare/1.2...1.3
[1.2]: https://github.com/dylanaraps/neoneofetch/compare/1.1...1.2
[1.1]: https://github.com/dylanaraps/neoneofetch/compare/1.0...1.1
[1.0]: https://github.com/dylanaraps/neoneofetch/compare/0.2.1...1.0
[0.2.1]: https://github.com/dylanaraps/neoneofetch/compare/0.2...0.2.1
[0.2]: https://github.com/dylanaraps/neoneofetch/compare/0.1...0.2
