...
This release focused on cleanup, bug fixes and optimization. Neoneofetch<br \>
...
<small><p align="center">Neoneofetch now works with bright colorschemes and uses the foreground color instead of hardcoding white.</p></small>
