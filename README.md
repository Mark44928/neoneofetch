...
\[1\] See **[#79](https://github.com/dylanaraps/neoneofetch/issues/79)** about why this is now a required dependency.
...
program's cmd and neoneofetch will use it instead of scrot.
...
Those using a git version of neoneofetch should check this page after<br \>
...
3. To enable additional features such as w3m and music support, enable the appropriate USE flags. For example:
    - `# echo "app-misc/neoneofetch X -moc" >> /etc/portage/package.use`
4. Install the package
    - `# emerge -a app-misc/neoneofetch`

To install the git version, just add `app-misc/neoneofetch ~<your architecture>` to `package.accept_keywords`
...
1. Add PPA
    - `sudo add-apt-repository ppa:dawidd0811/neoneofetch`
...
Neoneofetch will by default create a config file at `$HOME/.config/neoneofetch/config` and this file<br \>
...
## Usage
    ...
    usage: neoneofetch --option "value" --option "value"
    ...
    --disable infoname          Allows you to disable an info line from appearing
                                ...
                                'neoneofetch --disable cpu gpu disk shell'
    ...
    Stdout:
    --stdout info info          Launch neoneofetch in stdout mode which prints the info
    ...
    --version                   Show neoneofetch version
...
#### Why doesn't Neoneofetch support my wallpaper setter?
...
- [@konimex](https://github.com/konimex): Packaging neoneofetch for a wide range of distros.
- [@dawidd6](https://github.com/dawidd6): Packaging neoneofetch for Debian / Ubuntu.
