...
* [Making changes to Neoneofetch](#making-changes-to-neoneofetch)
...
# See: https://github.com/dylanaraps/neoneofetch/wiki/Shellcheck-Exclusions
shellcheck neoneofetch -e SC1090,SC2009,SC2012,SC2016,SC2034,SC2128,SC2153,SC2154,SC2178,SC2010,SC1004,SC1091,SC1117
```
