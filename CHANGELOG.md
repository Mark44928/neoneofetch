...
- Make neoneofetch compatible with `libedit`.
...
[**@nikitenich**](https://github.com/nikitenich), [**@Appadeia**](https://github.com/Appadeia), [**@marlonn**](https://github.com/marlonn), [**@Snuggle**](https://github.com/dylanaraps/neoneofetch/commits?author=Snuggle), [**@Phuurl**](https://github.com/Phuurl), [**@erikdubois**](https://github.com/erikdubois)
...
Added a new "simple" mode. You can now use neoneofetch for scripting
...
```sh
neoneofetch --chafa ~/Pictures/meow.jpg
```
