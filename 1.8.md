...
This version of neoneofetch is vastly different from the previous versions and this<br \>
...
- Neoneofetch no longer clears the screen when run in ascii or image=off modes.
    - You can use the old behaviour by aliasing `clear && neoneofetch` to `neoneofetch`.
