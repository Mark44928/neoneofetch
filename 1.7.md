...
Neoneofetch now supports displaying error messages and saving a verbose log for<br \>
troubleshooting.
...
\[1\] Neoneofetch tried to be smart before by assuming that the foreground color<br \>
